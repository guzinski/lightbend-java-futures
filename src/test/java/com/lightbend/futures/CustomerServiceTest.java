...
class CustomerServiceTest {
    ...
    void getCustomerFirstName_shouldExtractTheFirstNameFromTheCustomer() {
        ...
        Optional<String> result = customerService.getCustomerFirstName(customer.getId()).toCompletableFuture().join();
    ...
    void getCustomerLastName_shouldExtractTheLastNameFromTheCustomer() {
        ...
        Optional<String> result = customerService.getCustomerLastName(customer.getId()).toCompletableFuture().join();
    ...
    void getCustomerAddress_shouldExtractTheAddressFromTheCustomer() {
        ...
        Optional<String> result = customerService.getCustomerAddress(customer.getId()).toCompletableFuture().join();
    ...
    void getCustomerPhoneNumber_shouldExtractThePhoneNumberFromTheCustomer() {
        ...
        Optional<String> result = customerService.getCustomerPhoneNumber(customer.getId()).toCompletableFuture().join();
